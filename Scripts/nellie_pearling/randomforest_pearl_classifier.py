...
class PearlClassifier:
    ...
    def annotate_labels(
            self, pearl_label_metrics, image, labels, label_column="label_id"
    ):
        """
        ...
        centroids = np.array(
            annotated_metrics['location_micron'].tolist())  # Assuming 'location_pixel' is a list of coordinates
        ...
        viewer.add_points(centroids, size=0, name="Label IDs", text={
